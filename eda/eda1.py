...
def three_month_from_start(open_by_user, weights, carb_ent, bg_values):
    ...
    open_3m = open_3m.rename(columns={'appopen':'3month/week_open'})
    open_3m = open_3m.drop(['max_open/day', 'days_f0opn','churn'], axis=1)
    ...
    open_bg = pd.merge(open_3m, bg_3m , how='left', left_on='user_id', right_on='user_id')
    open_bg['3month_engagement']= open_bg['3month/week_open']*1.0/7
...
if __name__ == '__main__':
    ...
    grouped_add_1week = merge(grouped_add_1week, month_3_data)
    ...
    group_all_tables['engagement'] = group_all_tables['appopen']*1.0/(group_all_tables['use_age']+1)
